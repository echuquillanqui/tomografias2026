...
<div class="container">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            @if($order->consumables->count())
                <div class="card clinic-card p-4 mt-4">
                    <h6 class="fw-bold">Consumibles</h6>
                    <ul class="mb-0">@foreach($order->consumables as $c)<li>{{ $c->reagent->nombre }}: {{ $c->cantidad }} {{ $c->reagent->unidad_medida }}</li>@endforeach</ul>
                </div>
            @endif
