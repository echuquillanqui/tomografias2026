...
<div class="title-band"><div class="title-spacer"></div><h1 class="title">FICHA DE INGRESO</h1><div class="agreement"><?= e($admissionData['agreement'] ?? ($order->agreement->nombre_institucion ?? 'PARTICULAR')) ?></div></div>
<div class="box">
