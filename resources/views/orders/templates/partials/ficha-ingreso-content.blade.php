...
<table class="table table-bordered align-middle">
    <tbody>
        ...
        <tr><th>Observaciones</th><td colspan="5"><textarea name="observations" class="form-control form-control-sm" rows="2">{{ old('observations', $admissionData['observations'] ?? ($order->observaciones ?? '—')) }}</textarea></td></tr>
    </tbody>
</table>
<div class="row g-3">
