...
@php($orderDate = $order->fecha_orden ?? now())
<!doctype html><html><head><meta charset="utf-8"><style>.company-header{width:100%;border-bottom:1px solid #1f6fb2;margin-bottom:8px;padding-bottom:6px}.company-logo{max-height:45px;max-width:100px}.company-name{font-size:14px;font-weight:bold}.company-data{font-size:9px;color:#555}</style><style>body{font-family:DejaVu Sans,sans-serif;font-size:11px;line-height:1.45}.title{text-align:center;font-weight:bold;font-size:14px}.subtitle{text-align:center;font-size:10px}.line{border-bottom:1px dotted #000;display:inline-block;min-width:140px;text-align:center}.sig{width:230px;height:105px;border:1px solid #333;margin:18px auto 5px}.small{font-size:10px}</style></head><body>
...
<p>Yo, <span class="line" style="min-width:230px">&nbsp;</span> con DNI Nº <span class="line">&nbsp;</span> en mi condición de paciente/o representante legal del DNI Nº <span class="line">&nbsp;</span> autorizo a los profesionales Médico tratante, Médico Radiólogo, Tecnólogo Médico, Enfermera y Anestesiólogo, a efectuar los procedimientos necesarios para la realización del Estudio de Tomografía Computarizada. Manifiesto haber recibido la información siguiente:</p>
...
<p>Puno, <span class="line" style="min-width:35px">{{ $declarationData['day'] ?? $orderDate->format('d') }}</span> de <span class="line">{{ $declarationData['month'] ?? $orderDate->translatedFormat('F') }}</span> de <span class="line" style="min-width:55px">{{ $declarationData['year'] ?? $orderDate->format('Y') }}</span>. Hora: <span class="line">{{ $declarationData['hour'] ?? $orderDate->format('H:i') }}</span></p>
<table style="width:100%;margin-top:30px"><tr><td style="text-align:center;width:50%"><div class="sig"></div>Firma Paciente/Representante Legal</td><td style="text-align:center;width:50%"><div class="sig"></div>(Huella digital)<br>DNI Nº <span class="line">&nbsp;</span></td></tr></table>
<p><b>REVOCATORIA:</b></p>
