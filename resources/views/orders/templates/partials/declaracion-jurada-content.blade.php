<div class="mx-auto" style="max-width: 850px;">
    ...
    <p>
        Yo, <input class="form-control form-control-sm d-inline-block mx-1" style="width:260px" value="{{ $order->patient->nombres }} {{ $order->patient->apellidos }}"> con DNI Nº
        <input class="form-control form-control-sm d-inline-block mx-1" style="width:150px" value="{{ $order->patient->dni }}"> en mi condición de paciente/o representante legal del DNI Nº
        <input class="form-control form-control-sm d-inline-block mx-1" style="width:150px"> autorizo a los profesionales Médico tratante, Médico Radiólogo, Tecnólogo Médico, Enfermera y Anestesiólogo, a efectuar los procedimientos necesarios para la realización del Estudio de Tomografía Computarizada.
    </p>
    ...
    <div class="row g-2 align-items-end">
        <div class="col-md-3"><label class="form-label">Día</label><input class="form-control" value="{{ now()->format('d') }}"></div>
        <div class="col-md-3"><label class="form-label">Mes</label><input class="form-control" value="{{ now()->translatedFormat('F') }}"></div>
        <div class="col-md-3"><label class="form-label">Año</label><input class="form-control" value="{{ now()->format('Y') }}"></div>
        <div class="col-md-3"><label class="form-label">Hora</label><input class="form-control"></div>
    </div>
    <div class="row text-center mt-5">
        ...
        <div class="col"><div class="border rounded mx-auto mb-2" style="height:90px;max-width:220px"></div>Huella digital<br>DNI Nº <input class="form-control form-control-sm d-inline-block" style="width:160px" value="{{ $order->patient->dni }}"></div>
    </div>
