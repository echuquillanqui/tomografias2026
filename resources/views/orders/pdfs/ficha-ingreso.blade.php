...
<div class="box">
 ...
 <div class="row"><div class="cell patient-birthdate-cell"><span class="label">Fecha de nacimiento:</span> <?= e($birthdate) ?></div><div class="cell patient-age-cell"><span class="label">Edad:</span> <?= e($patientAgeLabel) ?></div><div class="cell patient-sex-cell"><span class="patient-sex-content"><span class="patient-sex-inner"><span class="label">Sexo:</span> <span class="<?= e($patientSexClass) ?>"><?= e($patientSex) ?></span></span></span></div><div class="cell patient-phone-cell"><span class="label">Cel:</span> <?= e($admissionData['patient_phone'] ?? ($order->patient->telefono ?? '—')) ?></div></div>
...
<div class="signatures-box">
    ...
    <table class="signature-layout">
        ...
        <tr>
            <td class="receipt-cell" colspan="2">
