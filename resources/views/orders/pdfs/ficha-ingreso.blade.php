...
<div class="box">
 ...
 <div class="row"><div class="cell" style="width:66.666%"><span class="label">Estudio solicitado:</span> <?= e($admissionData['study'] ?? $order->orderExams->pluck('exam.nombre_examen')->join(', ')) ?></div><div class="cell contrast-cell"><span class="red"><?= e($admissionData['contrast_label'] ?? ($hasContrast ? 'CON CONTRASTE' : 'SIN CONTRASTE')) ?></span></div></div>
</div>
