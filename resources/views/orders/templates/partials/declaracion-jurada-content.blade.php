...
<div class="mx-auto" style="max-width: 850px;">
    ...
    <div class="row g-2 align-items-end">
        <div class="col-md-3"><label class="form-label">Día</label><input name="day" class="form-control text-center" value="{{ old('day', $declarationData['day'] ?? $orderDate->format('d')) }}"></div>
        <div class="col-md-3"><label class="form-label">Mes</label><input name="month" class="form-control text-center" value="{{ old('month', $declarationData['month'] ?? $orderDate->translatedFormat('F')) }}"></div>
        <div class="col-md-3"><label class="form-label">Año</label><input name="year" class="form-control text-center" value="{{ old('year', $declarationData['year'] ?? $orderDate->format('Y')) }}"></div>
        <div class="col-md-3"><label class="form-label">Hora</label><input name="hour" class="form-control text-center" value="{{ old('hour', $declarationData['hour'] ?? $orderDate->format('H:i')) }}"></div>
    </div>
