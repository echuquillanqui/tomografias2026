...
<p>Puno, <span class="line" style="min-width:35px">{{ now()->format('d') }}</span> de <span class="line">{{ now()->translatedFormat('F') }}</span> de <span class="line" style="min-width:55px">{{ now()->format('Y') }}</span>. Hora: <span class="line">&nbsp;</span></p>
<table style="width:100%;margin-top:30px"><tr><td style="text-align:center;width:50%"><div class="sig"></div>Firma Paciente/Representante Legal</td><td style="text-align:center;width:50%"><div class="sig"></div>(Huella digital)<br>DNI Nº <span class="line">{{ $order->patient->dni }}</span></td></tr></table>
<p><b>REVOCATORIA:</b></p>
