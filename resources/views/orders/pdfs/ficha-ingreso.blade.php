        ...
        <tr>
            <?php foreach($deliveryItems as $option): ?>
                <td>
                    ...
                    <span class="delivery-quantity"><?= e($deliveryQuantities[$option] ?? ($option === 'PLACAS' ? ($admissionData['plates_count'] ?? '') : '')) ?></span>
                </td>
            <?php endforeach; ?>
        </tr>
    </tbody>
