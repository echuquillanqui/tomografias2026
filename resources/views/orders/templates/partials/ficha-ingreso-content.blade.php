...
<table class="table table-bordered align-middle">
    <tbody>
        <tr>
            ...
            <th>Fecha y hora de atención</th><td colspan="2"><input class="form-control form-control-sm" value="{{ $admissionData['date'] ?? $order->fecha_orden->format('d/m/Y H:i') }}" readonly><div class="form-text">Se actualizará automáticamente al guardar.</div></td>
        </tr>
...
<div class="row text-center mt-5"><div class="col"><div class="border rounded mx-auto mb-2" style="height:130px;max-width:260px"></div>Firma de paciente o apoderado<div class="mx-auto mb-4" style="height:24px;max-width:260px;border-bottom:1px solid currentColor"></div><div class="border rounded mx-auto mb-2" style="height:90px;max-width:260px"></div>Recibí conforme</div><div class="col"><div class="border rounded mx-auto mb-2" style="height:140px;max-width:140px"></div>Huella del paciente</div></div>
