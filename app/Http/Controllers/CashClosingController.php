...
class CashClosingController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('cash-closings.index', compact('from', 'to', 'orders', 'expenses', 'incomeTotal', 'expenseTotal') + [
    ...
    public function storeExpense(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('cash-closings.index', $request->only(['from', 'to']))->with('success', 'Egreso registrado correctamente.');
    }
